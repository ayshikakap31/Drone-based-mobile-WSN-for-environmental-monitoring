...
oneDrone = np.array(oneDrone)
coordinates_array = np.array(XYT1Drone)
...
#%%
oneDroneIDWInterpolated = np.zeros((t_lim,x_lim,y_lim))
...
nn_interpolated_values = griddata(coordinates_array, oneDrone, interpolation_coordinates, method='nearest')          
idw_interpolated_values = idw_interpolation(coordinates_array, oneDrone, interpolation_coordinates)
#%%
counter = 0
for z in range(0, t_lim):
    # print(z)
    for i in range(0, x_lim):
        for j in range(0, y_lim):
            ...
            oneDroneIDWInterpolated[coord[2]][coord[0]][coord[1]] = idw_interpolated_values[counter]
            oneDroneNearestInterpolated[coord[2]][coord[0]][coord[1]] = nn_interpolated_values[counter]
            counter += 1
 #%% For t=1 hours
# Plot the 3-dim data
...
# First ground truth plot
ax1 = fig.add_subplot(111, projection='3d')
surface1 = ax1.plot_surface(x, y, oneDroneIDWInterpolated[59], cmap='viridis')
plt.rcParams['font.family'] = 'Times New Roman'
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
ax1.tick_params(axis='z', labelsize=32, pad=15)
...
# First ground truth plot
ax1 = fig.add_subplot(111, projection='3d')
surface1 = ax1.plot_surface(x, y, oneDroneNearestInterpolated[59], cmap='viridis')
plt.rcParams['font.family'] = 'Times New Roman'
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
ax1.tick_params(axis='z', labelsize=32, pad=15)
...
surface2 = ax2.plot_surface(x, y, oneDroneIDWInterpolated[0], cmap='viridis')
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
...
surface3 = ax3.plot_surface(x, y, oneDroneNearestInterpolated[0], cmap='viridis')
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
...
# Second linear interpolated plot
ax2 = fig.add_subplot(132, projection='3d')
surface2 = ax2.plot_surface(x, y, oneDroneIDWInterpolated[19], cmap='viridis')
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
ax2.tick_params(axis='z', labelsize=32, pad=15)
...
# Third interpolated plot
ax3 = fig.add_subplot(133, projection='3d')
surface3 = ax3.plot_surface(x, y, oneDroneNearestInterpolated[19], cmap='viridis')
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
ax3.tick_params(axis='z', labelsize=32, pad=15)
...
# Second linear interpolated plot
ax2 = fig.add_subplot(132, projection='3d')
surface2 = ax2.plot_surface(x, y, oneDroneIDWInterpolated[49], cmap='viridis')
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
ax2.tick_params(axis='z', labelsize=32, pad=15)
...
# Third interpolated plot
ax3 = fig.add_subplot(133, projection='3d')
surface3 = ax3.plot_surface(x, y, oneDroneNearestInterpolated[49], cmap='viridis')
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
ax3.tick_params(axis='z', labelsize=32, pad=15)
...
ax2 = fig.add_subplot(132, projection='3d')
surface2 = ax2.plot_surface(x, y, oneDroneIDWInterpolated[99], cmap='viridis')
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
ax2.tick_params(axis='z', labelsize=32, pad=15)
...
# Third interpolated plot
ax3 = fig.add_subplot(133, projection='3d')
surface3 = ax3.plot_surface(x, y, oneDroneNearestInterpolated[99], cmap='viridis')
plt.yticks(fontsize=32)
plt.xticks(fontsize=32)
ax3.tick_params(axis='z', labelsize=32, pad=15)
...
for z in range(0, t_lim):
    ...
    for i in range(0, x_lim):
        for j in range(0, y_lim):
            oneDroneIDWError += ((groundTruth[z][i][j]-oneDroneIDWInterpolated[z][i][j])/groundTruth[z][i][j]) **2
            oneDroneNearestError += ((groundTruth[z][i][j]-oneDroneNearestInterpolated[z][i][j])/groundTruth[z][i][j]) **2
    oneDroneIDWError /= (x_lim*y_lim)
    overall_idw_rmse += oneDroneIDWError
    oneDroneIDWError = math.sqrt(oneDroneIDWError)
    
    oneDroneNearestError /= (x_lim*y_lim)
...
selected_time_points = np.arange(0,100,10)
selected_IDW_errors = []
selected_Nearest_errors = []
for i in selected_time_points:
    selected_IDW_errors.append(oneDroneIDWError_list[i])
    selected_Nearest_errors.append(oneDroneNearestError_list[i])
# Plot the RMS errors
